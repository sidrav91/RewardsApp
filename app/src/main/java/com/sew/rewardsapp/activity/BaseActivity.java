...
import com.sew.rewardsapp.pojo.NavDrawerItem;
import com.sew.rewardsapp.utils.NavDrawerListAdapter;

import java.util.ArrayList;

/**
 * Created by siddharthkumar on 24/1/18.
 */
...
public class BaseActivity extends AppCompatActivity { //changed from depricated ActionBarActivity
    ...
    public void set(String[] navMenuTitles, TypedArray navMenuIcons) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                ...
                R.array.menu, // nav drawer open - description for accessibility
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                Intent intent1 = new Intent(this, MyActivityGrid.class);
